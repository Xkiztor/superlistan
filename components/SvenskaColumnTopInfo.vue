...
const handleSort = (what) => {
  if (state.svenskaSortByWhat.value === what) {
    state.svenskaSortAscending.value = !state.svenskaSortAscending.value
  } else {
    state.svenskaSortByWhat.value = what
  }
}
</script>
